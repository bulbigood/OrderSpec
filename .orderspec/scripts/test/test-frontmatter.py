...
# ═══════════════════════════════════════════════════════════════════════════════
# spec tests (additional edge cases — existing tests in test-lint.py cover basics)
# ═══════════════════════════════════════════════════════════════════════════════
...
# 71. unknown artifact type
p = write_file("any.md", "---\norderspec:\n  artifact: x\n---\n")
rc, data = run_vfm("unknown_type", p)
if rc == 64:
    ok("71. unknown artifact type → exit 64")
else:
    bad("71. unknown artifact type", f"rc={rc}")

# 72. file not found
rc, data = run_vfm("spec", str(WORK / "nonexistent.md"))
if rc == 2:
    ok("72. file not found → exit 2")
else:
    bad("72. file not found", f"rc={rc}")

...
#
# Refresh the managed OrderSpec section in the coding agent's context file
...
$DefaultStart = '<!-- ORDERSPEC START -->'
$DefaultEnd   = '<!-- ORDERSPEC END -->'
$ProjectRoot  = (Get-Location).Path
$ExtConfig    = Join-Path $ProjectRoot '.orderspec/extensions/agent-context/agent-context-config.yml'
